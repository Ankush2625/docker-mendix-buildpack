...
ARG BUILDER_ROOTFS_IMAGE=mendix/rootfs:jammy
...
# Add the buildpack modules
ENV PYTHONPATH "/opt/mendix/buildpack/lib/:/opt/mendix/buildpack/:/opt/mendix/buildpack/lib/python3.10/site-packages/"
